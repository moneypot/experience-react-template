...
// Example of how we can set a static UUID to always load the same experience and user
// (Set your own from https://www.uuidgenerator.net/)
//
// const seed = "123e4567-e89b-12d3-a456-426614174000";
